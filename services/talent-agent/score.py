...
def evaluate_candidate(
    ...
    Args:
        ...
        prompt: The prompt to evaluate the candidate against
    ...
    Returns:
        List of float scores for the prompt (0.0-10.0 scale)
    """
    results = []
    ...
    exp_text = format_experience(experience)
    cert_text = format_certifications(certifications)
    project_text = format_projects(projects)
